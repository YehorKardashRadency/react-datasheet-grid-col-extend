...
const buildSquare = (top: number | string, right: number | string, bottom: number | string, left: number | string) => {
  return [
    [left, top],
    [right, top],
    [right, bottom],
    ...
    return (
      <>
            ...
            style={{
              ...
              width:
                contentWidth && viewWidth
                  ...
                  : `calc(100% - ${
                      columnWidths[0] + (hasStickyRightColumn ? columnWidths[columnWidths.length - 1] : 0)
                    }px)`
            }}
          />
        </div>
        {(selectionRect || activeCellRect) && !selectionIsDisabled && (
          <div
          ...
          >
            <div
              className={cx('dsg-selection-col-marker', selectionIsDisabled && 'dsg-selection-col-marker-disabled')}
        ...
        {(selectionRect || activeCellRect) && !selectionIsDisabled && (
          ...
          >
            <div
              className={cx('dsg-selection-row-marker', selectionIsDisabled && 'dsg-selection-row-marker-disabled')}
              style={{ left: columnWidths[0] }}
            />
          </div>
        )}
        {activeCellRect && activeCell && !selectionIsDisabled && (
          <div
        ...
        {selectionRect && activeCellRect && !selectionIsDisabled && (
          <div
            className={cx('dsg-selection-rect', selectionIsDisabled && 'dsg-selection-rect-disabled')}
            style={{
              ...selectionRect,
        ...
        {expandRowsIndicator && (
          <div
            className={cx('dsg-expand-rows-indicator', selectionIsDisabled && 'dsg-expand-rows-indicator-disabled')}
